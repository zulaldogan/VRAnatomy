...
public class Teleport : MonoBehaviour, ICardboardGazeResponder {
    ...
    public GameObject Muscles;//show et, unshow et
    public GameObject InfoImage;
    public string InformationString;

    private bool _isMusclesShow = false;
  ...
  public void SetGazedAt(bool gazedAt) {
        if (gazedAt)
        {
            //TODO : Body parçası hakkında bilgi çıkaracak. (Bu bir kafadır)
  ...
  //Dış Görünüşü Değiştirir
  public void ChangeCurrentAppearance()
  {
        _isMusclesShow = !_isMusclesShow;
        Muscles.SetActive(_isMusclesShow);
  }
